...
-- Volcando datos para la tabla sistema_asistencia.alumnos: ~2 rows (aproximadamente)
INSERT INTO `alumnos` (`dni`, `nombre`, `apellido`) VALUES
	(35126875, 'Kevin', 'Quiroga'),
	(44968785, 'Pablo', 'Martinez');
...
CREATE TABLE IF NOT EXISTS `asistencias` (
  ...
  CONSTRAINT `fk_alumno_asistencia` FOREIGN KEY (`dni_alumno`) REFERENCES `alumnos` (`dni`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Volcando datos para la tabla sistema_asistencia.asistencias: ~0 rows (aproximadamente)

-- Volcando estructura para tabla sistema_asistencia.profesores
...
-- Volcando datos para la tabla sistema_asistencia.profesores: ~0 rows (aproximadamente)
